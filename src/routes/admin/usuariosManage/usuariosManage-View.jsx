...
import { UserForm, UserDetailsView, UserDelAlert, UserRestoreAlert, AlertError, MembershipRenewalForm, CustomerSelect } from '../../../components/components';
...
import './usuariosManage.css'; // Asegúrate de que el archivo CSS está en la misma carpeta y correctamente referenciado
...
const usuariosManageView = (props) => {
    ...
    // Estado para controlar la visibilidad de CustomerSelect
...
export default usuariosManageView;